...
const Dashboard = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://hulkfit-backend-wowi.onrender.com/activitylist/dashboard/column/${userID}`
      )
      .then((result) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://hulkfit-backend-wowi.onrender.com/activitylist/dashboard/pie/${userID}`
      )
      .then((result) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://hulkfit-backend-wowi.onrender.com/aggregate/mostact/${userID}`
      )
      .then((result) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://hulkfit-backend-wowi.onrender.com/aggregate/mostduration/${userID}`
      )
      .then((result) => {
      ...
      <div className='container max-lg:shrink-0  flex flex-col gap-5 '>
        <div className='lg:flex lg:flex-row lg:justify-evenly m-1 flex flex-col  '>
          <div className='bg-indigo-50 shadow-xl p-10 lg:w-1/3 m-1 flex flex-col rounded-lg'>
            ...
            <p className='text-md'>
              Your stats activities explain what style you are
            </p>
            <br />
            <Radar {...configRadar} />
          </div>
          <div className='bg-indigo-50 shadow-xl p-10 lg:w-1/3 m-1 flex flex-col rounded-lg'>
            ...
            <p className='text-md'>
              All of your activities are shown as percentages for each activity
              type
            </p>
            <br />
            <Pie {...configPie} />
        ...
        <div className='bg-indigo-50 shadow-xl p-10 m-1 flex flex-col rounded-lg'>
          ...
          <p className='text-md'>
            Your daily activity is shown as a minute duration summary for each
            day
          </p>
          <br />
          <Column {...configColumn} />
        ...
        <div className='lg:flex lg:flex-row lg:justify-evenly flex flex-col '>
          <div className='bg-indigo-50 shadow-xl p-10 lg:w-1/2 m-1 flex flex-col rounded-lg'>
            ...
            <p className='text-md'>
              Your daily activity is shown as a percentage for each activity
              type
            </p>
            <br />
            <Bar {...configBar} />
          ...
          <div className='bg-indigo-50 shadow-xl p-10 lg:w-1/2 m-1 flex flex-col rounded-lg overflow-auto'>
            <p className='text-2xl text-bold'>Total Activities</p>
            <p className='text-md'>All of your activities are shown here</p>
            <br />
